...
<div id="header">
    ...
    <!-- End header -->
    <h1>Por favor, realize o seu <span style="color:#08a5ff;">cadastro</span> e aproveite as ofertas!</h1>
    ...
    <div id="content">
		<div id="contact_us_left_coloumn">
			...
			<form action="CadastroServlet" method="post">
  				<tr>
    				<td width="187">Nome completo:</td>
    				<td width="299"><input name="nome" type="text" size="40" /></td>
  				</tr>
  				<tr>
   					<td>Senha:</td>
 				...
 				<tr>
    				<td>RG:</td>
    				<td><input name="rg" type="text" size="40" /></td>
  				</tr>
				<tr>
    				<td>CPF:</td>
    				<td><input name="cpf" type="text" size="40" /></td>
  				</tr>
				<tr>
    				<td>Número do cartão de crédito:</td>
    				<td><input name="numero_cartao" type="text" size="40" /></td>
  				</tr>
				<tr>
    				<td>Telefone residencial:</td>
    				<td><input name="tel_residencial" type="text" size="40" /></td>
  				</tr>
				<tr>
    				<td>Celular:</td>
    				<td><input name="tel_celular" type="text" size="40" /></td>
  				</tr>
